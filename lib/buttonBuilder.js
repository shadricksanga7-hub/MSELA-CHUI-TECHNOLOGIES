 ...
 * buttonBuilder.js
 *
 * CommonJS port of MSELA-CHUI-XMD's ButtonV2 class (lib/WABuilder.js).
 * Lets any MSELA-CHUI command send quick-reply buttons the same way
 * MSELA-CHUI-XMD's fullmenu.js does, without needing the full WABuilder file
