...
async function muteCommand(dest, client, options) {
  ...
  if (!options.verifBlazetzAdmin && !options.superUser) return repondre('❌ MSELA-CHUI-XMD must be a group admin to delete muted messages.');
