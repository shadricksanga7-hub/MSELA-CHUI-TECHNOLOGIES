...
blazetz({
  ...
  if (!verifBlazetzAdmin) return repondre('❌ Please make MSELA-CHUI-XMD a group admin first.');
  ...
  const message = arg?.length ? arg.join(' ') : 'MSELA-CHUI-XMD group announcement';
