...
function decodeSessionId(_0x208c32) {
    ...
    _0x4e28a1 = _0x4e28a1['replace'](/^['"]|['"]$/g, '')['trim'](), _0x4e28a1 = _0x4e28a1['replace'](/^(?:SESSION_ID\s*=\s*|(?:BLAZE(?:-TECH)?|MSELA(?: CHUI)?(?:-XMD)?)~)/i, ''), _0x4e28a1 = _0x4e28a1['replace'](/\s+/g, '')['replace'](/-/g, '+')["replace"](/_/g, '/');
    ...
    if (parsed['registered'] !== true) throw new Error('Session ID is not fully registered; generate a new session after pairing completes');
